...
class NewCosmeticsAdapter(val listener: CosmeticsAdapterItemListener) :
    RecyclerView.Adapter<NewCosmeticsAdapter.ContentViewHolder>() {

    private var cosmeticsList: MutableList<ListOfNewItemsEntity> = mutableListOf()

    private val searchList: MutableList<ListOfNewItemsEntity> = mutableListOf()
    ...
    inner class ContentViewHolder(private val binding: ItemFilmBinding) :
        ...
        fun bind(cosmetic: ListOfNewItemsEntity) {
            binding.apply {
                ...
                image.loadFromUrl(cosmetic.images.icon)
...
interface CosmeticsAdapterItemListener {
